...
const RulesPage = () => {
  ...
  const englishRules = [
    ...
    "No assistance will be provided in cases of suicide or murder. In murder cases, an investigation will be conducted, and assistance may be given in some cases. Assistance will not be provided in these murder cases: • If the nominee kills the member. • If a close relative kills the member to gain the assistance. • If the member goes to kill someone and is murdered in the process. • If the member is murdered due to enmity. • If the member is murdered during a police case.",
  ...
  // Hindi Rules
 const hindiRules = [
  "सिर्फ Telegram का Member बनने या Registration form भर देने से आप BEES Foundation के Member नहीं बनेंगे। हर महीने Rs.300 देने पर आप Member बनेंगे और Foundation से फायदे उठा पाएंगे।",
  "कोई भी बालिग Foundation का Member बन सकता है।",
  "BEES Foundation एक N.G.O है जो शिक्षा के सुधार और बढ़ावे के लिए काम कर रही है। आपके द्वारा दिए गये योगदान से Foundation शिक्षा के क्षेत्र में काम करेगी और Members को उनकी असामयिक मृत्यु (60 से पहले) पर उनके घर वालों (Nominee / Nominees) की मदद करेगी और गंभीर एक्सीडेंट के केस में भी मदद की जाएगी।",
  "Foundation आपकी मदद करे ही करे इसकी कोई गारंटी नहीं है। क्योंकि Foundation Members के ऊपर निर्भर करती है। अगर किसी कारण Members ने योगदान नहीं दिया या कोई Technical Problem हो गई जैसे Hacking आदि तो ऐसी परिस्थिति में Foundation के पास आपको देने के लिए Fund नहीं होगा।",
  ...
  "Member बनने के बाद आपको लगातार योगदान देते रहना है। साल में एक बार की छूट लेकिन उसके लिए आपको योगदान ना देने का कारण लिखित में देना होगा।",
  ...
  "आत्महत्या और हत्या के मामलों में कोई मदद नहीं की जाएगी। हत्या के मामलों की जांच की जाएगी, कुछ मामलों में मदद दी जा सकती है। हत्या के इन cases में मदद नहीं की जाएगी: • अगर नॉमिनी Member का कर दे। • कोई सगा रिश्तेदार मदद मिलने के लालच में कर दे। • Member किसी को मारने जाए और खुद का मर्डर हो जाए। • दुश्मनी में मारा जाए। • Police case में मारा जाए।",
  "एक से अधिक नॉमिनी होने पर Foundation अपने हिसाब से मदद की राशी को बांटेगी।",
  "Nominee की ID, आधार और बैंक डिटेल्स देनी होंगी।",
  ...
  "Foundation का उद्देश्य अपने सदस्यों की मदद करने के साथ-साथ शिक्षा के क्षेत्र में काम करना भी है। Foundation अपनी गतिविधियों के लिए 15-20% धनराशि बचाएगा और सदस्यों की संख्या बढ़ने पर यह प्रतिशत बढ़ाया भी जा सकता है।",
